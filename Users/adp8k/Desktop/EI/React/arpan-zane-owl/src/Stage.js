...
const stageFolk = participants.filter(person=>person.onStage===true)
    .map(person => <Participant key={person.id} name={person.name} avatar={person.avatar}  onStage={person.onStage} />)
